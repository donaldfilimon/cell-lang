...
const Emitter = struct {
    ...
    fn emitMatch(
        ...
        // module. `cf.assert` is a registered op that lowers to an abort with
        // this exact message, so the trap is real and the message survives.
        // The C and LLVM backends call `cell_panic`; all three abort, and the
        // difference in mechanism is recorded here rather than hidden.
