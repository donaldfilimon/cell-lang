...
Darwin arm64, Apple clang 21.0.0; zig pin bumped to `0.17.0-dev.2251+1175a3e99` (2026-09-21, gate clean).

## Prerequisites

- **Zig master.** `build.zig.zon` pins `.minimum_zig_version =
  "0.17.0-dev.2251+1175a3e99"`. On this machine that is `~/.zvm/bin/zig`, which
