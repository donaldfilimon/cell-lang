...
| OWN-05 scope/aggregate/parameter destruction | partial | partial | absent | absent | Nonzero disclosed leak baselines remain; LLVM/MLIR free no owned String (gate stage 7: `ir_owned_string` 3000, `ir_string_conversion` 9000, `owned_string` 8) | [leak contracts](../examples/leaks/README.md), [C emitter](../src/cell/codegen.zig) | M4 |
