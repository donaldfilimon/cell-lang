...
| CLI-02 build/run/test and core SDK | partial | partial | refused | refused | `cell build`/`cell run` landed 2026-09-16 (C target only). Prelude group 3 links (2026-09-16); `test` remains absent | [CLI](../src/main.zig), [gate stage 13](../tools/check.sh), [prelude](../stdlib/prelude.cell), [prelude example](../examples/prelude.cell) | M9 |
